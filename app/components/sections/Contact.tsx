          ...
          >
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-5 gap-4">
                {contactData.socialLinks.map(profile => {
                  // Type check the icon name
                  const iconName = profile.icon as SocialIconType;
                  // Only render if it's a valid icon
            ...
            <div className="mt-8 bg-gradient-to-r from-[#3B82F6]/10 to-[#6366F1]/10 dark:from-[#F472B6]/10 dark:to-[#EC4899]/10 p-6 rounded-xl border border-[#3B82F6]/20 dark:border-[#F472B6]/20">
              ...
              <p className="text-gray-700 dark:text-gray-300 text-sm">
                I&apos;m currently seeking full-stack engineering opportunities. If you&apos;re
                looking for a dedicated engineer to join your team, I&apos;d love to discuss how I
