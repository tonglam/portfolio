...
import certificates from '@/app/data/certificates.data';
import { developerProfileCode } from '@/app/data/codeSnippets.data';
...
import type { IconComponent, SocialIconType } from '@/types/data/social.type';
