  ...
  return (
    <motion.nav
      ...
      className={`fixed w-full top-0 z-50 transition-all duration-300 ${
        scrolled
          ? "py-2 bg-white/95 dark:bg-gradient-to-r dark:from-[#0F172A]/95 dark:to-[#1E293B]/95 shadow-md"
          : "py-3 sm:py-4 bg-white/90 dark:bg-gradient-to-r dark:from-[#0F172A]/90 dark:to-[#1E293B]/90"
    ...
    >
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center">
          <Link
            href="/"
            className="bg-clip-text text-transparent bg-gradient-to-r from-[#2563EB] to-[#4F46E5] dark:from-[#38BDF8] dark:to-[#818CF8] text-xl sm:text-2xl font-bold"
          >
            TONG
          </Link>
