...
export default function Education() {
  return (
    <section id="education" className="py-16 md:py-20 bg-white dark:bg-gradient-to-b dark:from-[#0F172A] dark:to-[#1E293B]">
      <div className="container mx-auto px-4">
                ...
                <div className={`flex flex-col md:flex-row items-start ${index % 2 === 0 ? 'md:flex-row-reverse' : ''}`}>
                  ...
                  <div className={`ml-16 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-16 md:text-right' : 'md:pl-16'}`}>
                    ...
                    >
                      ...
                      <h3 className="text-lg md:text-xl font-bold mb-3 text-gray-900 dark:text-white">{edu.degree}</h3>
                        ...
                        {index === 0 && (
                          <div className="space-y-2">
                            <div className="flex items-center">
                              ...
                              <span className="text-sm text-gray-600 dark:text-gray-400">Specialization in Web Development</span>
                            </div>
                            <div className="flex items-center">
                              <span className="w-2 h-2 bg-[#3B82F6] dark:bg-[#F472B6] rounded-full mr-2"></span>
                              <span className="text-sm text-gray-600 dark:text-gray-400">Advanced Cloud Computing</span>
                            </div>
                          </div>
                        )}
                        {index === 1 && (
                          <div className="space-y-2">
                            <div className="flex items-center">
                              <span className="w-2 h-2 bg-[#3B82F6] dark:bg-[#F472B6] rounded-full mr-2"></span>
                              <span className="text-sm text-gray-600 dark:text-gray-400">Computer Science & Technology</span>
                            </div>
                            <div className="flex items-center">
                              <span className="w-2 h-2 bg-[#3B82F6] dark:bg-[#F472B6] rounded-full mr-2"></span>
                              <span className="text-sm text-gray-600 dark:text-gray-400">Software Engineering Focus</span>
                            </div>
                          </div>
                        )}
                      </div>
        ...
        >
          <div className="bg-white dark:bg-gradient-to-br dark:from-[#1E293B] dark:to-[#2D3748] rounded-lg p-4 text-center shadow-md">
            <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#3B82F6] to-[#6366F1] dark:from-[#F472B6] dark:to-[#EC4899]">6+</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Years of Learning</div>
          </div>
          <div className="bg-white dark:bg-gradient-to-br dark:from-[#1E293B] dark:to-[#2D3748] rounded-lg p-4 text-center shadow-md">
            <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#3B82F6] to-[#6366F1] dark:from-[#F472B6] dark:to-[#EC4899]">2</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Degrees</div>
          </div>
          <div className="bg-white dark:bg-gradient-to-br dark:from-[#1E293B] dark:to-[#2D3748] rounded-lg p-4 text-center shadow-md">
            <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#3B82F6] to-[#6366F1] dark:from-[#F472B6] dark:to-[#EC4899]">10+</div>
            <div className="text-sm text-gray-600 dark:text-gray-400">Projects</div>
          </div>
          <div className="bg-white dark:bg-gradient-to-br dark:from-[#1E293B] dark:to-[#2D3748] rounded-lg p-4 text-center shadow-md">
            <div className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#3B82F6] to-[#6366F1] dark:from-[#F472B6] dark:to-[#EC4899]">∞</div>
