...
export default function Projects() {
  ...
  const categories = ["All", ...Array.from(new Set(projectsData.map(project => project.category || "Other")))];
  ...
  return (
    <section id="projects" className="py-16 md:py-20 bg-white dark:bg-gradient-to-b dark:from-[#1E293B] dark:to-[#0F172A]">
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-2xl md:text-3xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-r from-[#2563EB] to-[#4F46E5] dark:from-[#38BDF8] dark:to-[#818CF8]">PROJECTS</h2>
          <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto md:mx-0 text-sm md:text-base">
            ...
            from responsive front-end designs to complex back-end systems.
          </p>
        </motion.div>
            ...
            {filteredProjects.slice(0, visibleProjects).map((project, index) => (
              ...
              >
                <div className="p-5 md:p-6 flex flex-col h-full">
                  ...
                  >
                    <h4 className="text-xs font-semibold text-gray-700 dark:text-gray-400 mb-2">Technologies:</h4>
                      ...
                      {project.technologies.slice(0, 6).map((tech, techIndex) => (
                        <motion.span 
                          ...
                          whileHover={{ 
                            ...
                            color: "#3B82F6",
                            dark: { backgroundColor: "rgba(244, 114, 182, 0.2)", color: "#F472B6" }
                          }}
                        >
                          {tech}
                        </motion.span>
