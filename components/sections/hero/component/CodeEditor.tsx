...
import { highlightCodeSyntax } from '@/lib/codeHighlighter.util';
...
export default function CodeEditor() {
  const { displayedCode, isTyping, currentLine }: TypewriterResult = useTypewriter(
    developerProfileCode,
    { typingSpeed: 40, startDelay: 500 }
  );
