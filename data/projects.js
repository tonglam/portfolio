...
export const projectsData = [
  {
    ...
    category: "Backend",
    githubUrl: EXTERNAL_URLS.PROJECT.GITHUB,
    demoUrl: EXTERNAL_URLS.PROJECT.DEMO,
    code: `const project = {
  ...
  },
  {
    ...
    description:
      "A recipe sharing application where users can discover, share, and save recipes.",
  ...
  },
  {
    ...
    description:
      "An inventory management system for tracking products, orders, and stock levels.",
